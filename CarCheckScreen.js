...
const CarCheckScreen = props => {
  ...
  async function fetchData() {
    try {
      ...
      if (value !== null) {
        ...
        let url = `http://cic.1966.org.tw/api/DriverInfo/GetDriverCheck/${
  ...
  const fetchDataModal = async () => {
    let url = `http://cic.1966.org.tw/api/CheckItem/GetCheckCarViewModel`;
  ...
  const handleSubmit = async () => {
    ...
    let url =
      'http://cic.1966.org.tw/api/CheckResult/PostCheckCarMapping';
