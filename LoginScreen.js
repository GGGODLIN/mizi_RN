...
class LoginScreen extends Component {
  ...
  handleLogin = async () => {
    ...
    let url = `http://care.1966.org.tw/api/api/DriverInfo/DriverLogin?`;
  ...
  handleSendAcc = async () => {
    let url = `http://care.1966.org.tw/api/api/DriverInfo/PushPhoneMessage?phoneNum=${
      this.state.input1
    }`;
  ...
  handleSendVCode = async () => {
    let url = `http://care.1966.org.tw/api/api/DriverInfo/CheckPhoneCode?phoneNum=${
      this.state.input1
  ...
  handleSendNewPwd = async () => {
    let url = `http://care.1966.org.tw/api/api/DriverInfo/PutForgetPassword?cAccount=${
      this.state.input1
