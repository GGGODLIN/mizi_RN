...
class LoginScreen extends Component {
  ...
  handleLogin = async () => {
    let url = `http://www.e9life.com/api/DriverInfo/DriverLogin?`;
  ...
  handleSendAcc = async () => {
    let url = `http://www.e9life.com/api/DriverInfo/PushPhoneMessage?phoneNum=${
      this.state.input1
    }`;
  ...
  handleSendVCode = async () => {
    let url = `http://www.e9life.com/api/DriverInfo/CheckPhoneCode?phoneNum=${
      this.state.input1
  ...
  handleSendNewPwd = async () => {
    let url = `http://www.e9life.com/api/DriverInfo/PutForgetPassword?cAccount=${
      this.state.input1
