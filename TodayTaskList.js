...
const TodayTaskList = props => {
  ...
  async function fetchData() {
    try {
      ...
      if (value !== null) {
        ...
        var url2 =
          'http://ttcapi.1966.org.tw/api/DriverInfo/GetAllGroupDriverSide/' +
          obj_value.response.Id;
        //let url = `http://ttcapi.1966.org.tw/api/DriverInfo/GetAllGroup/${obj_value.Cars.DriverId}`;
  ...
  async function fetchData_test() {
    const data = await fetch(
      'http://ttcapi.1966.org.tw/api/DriverInfo/GetAllPassGroup/15',
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
