...
const TodayTaskOpen = props => {
  ...
  const askCash = async () => {
    setaskingMoney(true);
    let url = `http://tccdonkeyapi.1966.org.tw/api/OrderDetails/PutDetailRealWith?OrderDetailId=${
  ...
  const updateStatus = async () => {
    let url = `http://tccdonkeyapi.1966.org.tw/api/OrderDetails/PutDetailStatus?OrderDetailId=${
      taskData[detailIndex].OrderDetails.Id
