...
const HistoryTaskOpen = props => {
  ...
  const askCash = async () => {
    let url = `http://ttcapi.1966.org.tw/api/OrderDetails/PutDetailRealWith?OrderDetailId=${
  ...
  const postPic = async () => {
    ...
    let url = `http://ttcapi.1966.org.tw/api/Img/Pic`;
  ...
  const updateStatus = async () => {
    let url = `http://ttcapi.1966.org.tw/api/OrderDetails/PutDetailStatus?OrderDetailId=${
      taskData[detailIndex].OrderDetails.Id
        ...
        <View
          ...
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            <Text style={{fontSize: 30, fontWeight: 'bold', color: 'orange'}}>
              {caseStatus[detailIndex]===6? taskData[detailIndex]?.OrderDetails?.RealTotalAmt : (taskData[detailIndex].OrderDetails.RevisionSelfAmt+taskData[detailIndex].OrderDetails.OtherAmt)}
            </Text>
          </View>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text
