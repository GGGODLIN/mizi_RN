...
const HitCard = props => {
  ...
  async function fetchData() {
    ...
    try {
      ...
      if (value !== null) {
        ...
        var url2 =
          'http://ttsdapi.1966.org.tw/api/DriverInfo/GetAllPunchByDriver/' +
        ...
        var url3 =
          'http://ttsdapi.1966.org.tw/api/DriverInfo/GetDriverReceive/' +
          obj_value.response.Cars.DriverId;
  ...
  async function handleSubmitHitCard() {
    var url2 = `http://ttsdapi.1966.org.tw/api/DriverInfo/SetPunchTime/${
  ...
  const postPic = async picPath2 => {
    ...
    let url = `http://ttsdapi.1966.org.tw/api/Img/Pic`;
    ...
    const data = await fetch(url, {
      ...
      .then(async res => {
        ...
        let url2 =
          'http://ttsdapi.1966.org.tw/api/DriverInfo/PutDriverReceiveSign';
