...
const HitCard = props => {
  ...
  async function fetchData() {
    ...
    try {
      ...
      if (value !== null) {
        ...
        var url2 =
          'http://tccdonkeyapi.1966.org.tw/api/DriverInfo/GetAllPunchByDriver/' +
        ...
        var url3 =
          'http://tccdonkeyapi.1966.org.tw/api/DriverInfo/GetDriverReceive/' +
          obj_value.response.Id;
  ...
  async function handleSubmitHitCard() {
    var url2 = `http://tccdonkeyapi.1966.org.tw/api/DriverInfo/SetPunchTime/${
      user.response.Id
    }?status=${status}`;
  ...
  const postPic = async picPath2 => {
    ...
    let url = `http://tccdonkeyapi.1966.org.tw/api/Img/Pic`;
    ...
    const data = await fetch(url, {
      ...
      .then(async res => {
        ...
        let url2 =
          'http://tccdonkeyapi.1966.org.tw/api/DriverInfo/PutDriverReceiveSign';
